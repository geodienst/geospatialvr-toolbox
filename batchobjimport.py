...
def main(obj_input_dir,output_gdb_path,output_gdb_name):
	...
	outputfc = output_gdb_path + output_gdb_name + '/' + output_fc_name
	outputfc2d = output_gdb_path + output_gdb_name + '/' + 'footprint2d'
	...
	print('start import')
	arcpy.ddd.Import3DFiles(objlist,outputfc, False, sr)
